      ...
      <tr>
        ...
        <td className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
          <div className="flex items-center">
            <button
              className={`text-gray-400 hover:text-gray-500 ${open && 'rotate-180'}`}
              aria-expanded={open}
        ...
        <td colSpan={10} className="px-2 first:pl-5 last:pr-5 py-3">
          <div className="bg-gray-50 p-3 -mt-3">
            <div className="text-sm mb-3">
              <div className="font-medium text-gray-800 mb-1">{item.descriptionTitle}</div>
              <div>{item.descriptionBody}</div>
            </div>
            <button className="btn-sm bg-gray-900 text-gray-100 hover:bg-gray-800">Approve</button>
          </div>
        </td>
      </tr>
    </tbody>
