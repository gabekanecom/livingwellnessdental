  ...
  return (
    <Transition appear show={isOpen}>
      <Dialog as="div" onClose={() => setIsOpen(false)}>
        ...
        >
          <DialogPanel className="bg-white border border-transparent overflow-auto max-w-2xl w-full max-h-full rounded-lg shadow-lg">
            {/* Search form */}
            <form className="border-b border-gray-200">
              <div className="relative">
                <label htmlFor="search-modal" className="sr-only">Search</label>
                <input id="search-modal" className="w-full bg-white border-0 focus:ring-transparent placeholder-gray-400 appearance-none py-3 pl-10 pr-4" type="search" placeholder="Search Anything…" />
                ...
                <ul className="text-sm">
                  <li>
                    ...
                    >
                      ...
                      <span><span className="font-medium">Messages</span> - <span className="text-gray-600">Conversation / … / Mike Mills</span></span>
                    </Link>
                  </li>
                  <li>
                    <Link
                    ...
                    >
                      ...
                      <span><span className="font-medium">Messages</span> - <span className="text-gray-600">Conversation / … / Eva Patrick</span></span>
                    </Link>
                  </li>
                </ul>
              </div>
