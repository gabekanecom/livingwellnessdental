    ...
    <>
      {open &&
        <div className={className} role="alert">
          <div className="inline-flex flex-col w-full max-w-lg px-4 py-2 rounded-lg text-sm bg-white shadow-sm border border-gray-200 text-gray-600">
            ...
            <div className="text-right mt-1">
              <a className="font-medium text-violet-500 hover:text-violet-600" href="#0">Action -&gt;</a>
            </div>
          </div>
        </div>
      }
