...
export default function CourseAnalyticsDetailPage({ params }: { params: Promise<{ id: string }> }) {
  const { id } = use(params);
    ...
    return (
      <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-[96rem] mx-auto">
        <div className="text-center py-12">
          ...
          <Link href="/lms/analytics" className="text-violet-600 hover:text-violet-700 mt-4 inline-block">
            ← Back to LMS Analytics
          </Link>
        </div>
      </div>
    );
