              ...
              <tr>
                <td className="p-2 whitespace-nowrap md:w-1/2">
                  <div className="flex items-center">
                    ...
                    <div>
                      <div className="text-gray-800 uppercase">Gvolt</div>
              ...
              <tr>
                <td className="p-2 whitespace-nowrap md:w-1/2">
                  <div className="flex items-center">
                    ...
                    <div>
                      <div className="text-gray-800 uppercase">Fb</div>
              ...
              <tr>
                <td className="p-2 whitespace-nowrap md:w-1/2">
                  <div className="flex items-center">
                    ...
                    <div>
                      <div className="text-gray-800 uppercase">Googl</div>
              ...
              <tr>
                <td className="p-2 whitespace-nowrap md:w-1/2">
                  <div className="flex items-center">
                    ...
                    <div>
                      <div className="text-gray-800 uppercase">Aapl</div>
              ...
              <tr>
                <td className="p-2 whitespace-nowrap md:w-1/2">
                  <div className="flex items-center">
                    ...
                    <div>
                      <div className="text-gray-800 uppercase">Coin</div>
