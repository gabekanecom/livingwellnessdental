...
export default function FintechCard11() {
  ...
  return (
    <div className="flex flex-col col-span-full sm:col-span-6 xl:col-span-3 bg-white shadow-sm rounded-xl">
      <div className="px-5 pt-5">
        <header>
          <h3 className="text-sm font-semibold text-gray-500 uppercase mb-1">
            <span className="className="text-gray-800 - Amazon Inc.">
          </h3>
          <div className="text-2xl font-bold text-gray-800 mb-1">$3,400.35</div>
