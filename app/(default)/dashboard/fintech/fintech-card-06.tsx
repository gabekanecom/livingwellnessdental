              ...
              <tr>
                <td className="p-2 whitespace-nowrap">
                  <div className="flex items-center">
                    ...
                    <div className="font-medium text-gray-800">Acme LTD UK</div>
                  </div>
                </td>
                <td className="p-2 whitespace-nowrap">
                  <div>Revolut</div>
              ...
              <tr>
                <td className="p-2 whitespace-nowrap">
                  <div className="flex items-center">
                    ...
                    <div className="font-medium text-gray-800">Analytics Services</div>
                  </div>
                </td>
                <td className="p-2 whitespace-nowrap">
                  <div>Qonto</div>
              ...
              <tr>
                <td className="p-2 whitespace-nowrap">
                  <div className="flex items-center">
                    ...
                    <div className="font-medium text-gray-800">Happy Pills</div>
                  </div>
                </td>
                <td className="p-2 whitespace-nowrap">
                  <div>Revolut</div>
