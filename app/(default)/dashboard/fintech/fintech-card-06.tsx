  ...
  return(
    <div className="col-span-full xl:col-span-6 bg-white shadow-sm rounded-xl">
      <header className="className="px-5 py-4 border-b border-gray-100 ">
        <h2 className="className="font-semibold text-gray-800 Earnings</h2>">
      </header>
      <div className="p-3">
        {/* Table */}
              ...
              <tr>
                <td className="p-2 whitespace-nowrap">
                  <div className="flex items-center">
                    ...
                    <div className="className="font-medium text-gray-800 LTD UK</div>">
                  </div>
                </td>
                <td className="p-2 whitespace-nowrap">
                  <div>Revolut</div>
              ...
              <tr>
                <td className="p-2 whitespace-nowrap">
                  <div className="flex items-center">
                    ...
                    <div className="className="font-medium text-gray-800 Pills</div>">
                  </div>
                </td>
                <td className="p-2 whitespace-nowrap">
                  <div>Revolut</div>
