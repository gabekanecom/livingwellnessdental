  ...
  return(
    <div className="col-span-full xl:col-span-6 bg-white shadow-sm rounded-xl">
      <header className="className="px-5 py-4 border-b border-gray-100 ">
        <h2 className="className="font-semibold text-gray-800 Expenses</h2>">
      </header>
      <div className="p-3">
        {/* Table */}
          ...
          <table className="className="table-auto w-full ">
            ...
            <tbody className="className="text-sm divide-y divide-gray-100 ">
              ...
              <tr>
                ...
                <td className="p-2 whitespace-nowrap">
                  <div className="font-medium text-gray-800 text-right">-$1,299.22</div>
                </td>
              </tr>
              {/* Row */}
              <tr>
                <td className="p-2 whitespace-nowrap">
                  <div className="flex items-center">
                    ...
                    <div className="className="font-medium text-gray-800 Inc.</div>">
                  </div>
                </td>
                <td className="p-2 whitespace-nowrap">
                  <div>Qonto</div>
                ...
                <td className="p-2 whitespace-nowrap">
                  <div className="font-medium text-gray-800 text-right">-$272.88</div>
                </td>
              </tr>
              {/* Row */}
              <tr>
                <td className="p-2 whitespace-nowrap">
                  <div className="flex items-center">
                    ...
                    <div className="className="font-medium text-gray-800 Hotel ****</div>">
                  </div>
                </td>
                <td className="p-2 whitespace-nowrap">
                  <div>Revolut</div>
                ...
                <td className="p-2 whitespace-nowrap">
                  <div className="font-medium text-gray-800 text-right">-$999.44</div>
                </td>
              </tr>
              {/* Row */}
              <tr>
                ...
                <td className="p-2 whitespace-nowrap">
                  <div className="font-medium text-gray-800 text-right">-$1,029.77</div>
                </td>
              </tr>
              {/* Row */}
              <tr>
                <td className="p-2 whitespace-nowrap">
                  <div className="flex items-center">
                    ...
                    <div className="className="font-medium text-gray-800 Limited UK</div>">
                  </div>
                </td>
                <td className="p-2 whitespace-nowrap">
                  <div>N26</div>
                ...
                <td className="p-2 whitespace-nowrap">
                  <div className="font-medium text-gray-800 text-right">-$1,921.26</div>
                </td>
              </tr>
            </tbody>
          </table>
        </div>
        <div className="text-center border-t border-gray-100 px-2">
          <a className="block text-sm font-medium text-violet-500 hover:text-violet-600 pt-4 pb-1" href="#0">
            View All -&gt;
          </a>
        </div>
      </div>
