              ...
              <tr>
                <td className="p-2 whitespace-nowrap">
                  <div className="flex items-center">
                    ...
                    <div className="font-medium text-gray-800">Tech Inc.</div>
                  </div>
                </td>
                <td className="p-2 whitespace-nowrap">
                  <div>Qonto</div>
              ...
              <tr>
                <td className="p-2 whitespace-nowrap">
                  <div className="flex items-center">
                    ...
                    <div className="font-medium text-gray-800">Grand Hotel</div>
                  </div>
                </td>
                <td className="p-2 whitespace-nowrap">
                  <div>Revolut</div>
              ...
              <tr>
                <td className="p-2 whitespace-nowrap">
                  <div className="flex items-center">
                    ...
                    <div className="font-medium text-gray-800">Delivery Service</div>
                  </div>
                </td>
                <td className="p-2 whitespace-nowrap">
                  <div>N26</div>
              ...
              <tr>
                <td className="p-2 whitespace-nowrap">
                  <div className="flex items-center">
                    ...
                    <div className="font-medium text-gray-800">Acme Limited UK</div>
                  </div>
                </td>
                <td className="p-2 whitespace-nowrap">
                  <div>N26</div>
