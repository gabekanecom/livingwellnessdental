...
export default function FintechIntro() {
  return(
    <div className="flex flex-col col-span-full bg-white shadow-sm rounded-xl">
      <div className="px-5 py-6">
        <div className="md:flex md:justify-between md:items-center">
          ...
          <ul className="shrink-0 flex flex-wrap justify-end md:justify-start -space-x-3 -ml-px">
            ...
            <li>
              <button className="flex justify-center items-center w-9 h-9 rounded-full bg-white border border-gray-200 hover:border-gray-300 text-violet-500 shadow-sm transition">
