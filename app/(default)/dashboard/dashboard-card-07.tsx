export default function DashboardCard07() {
  return(
    <div className="col-span-full xl:col-span-8 bg-white shadow-sm rounded-xl">
              ...
              <tr>
                <td className="p-2">
                  <div className="flex items-center">
                    ...
                    <div className="text-gray-800">Facebook.com</div>
                  </div>
                </td>
                <td className="p-2">
              ...
              <tr>
                <td className="p-2">
                  <div className="flex items-center">
                    ...
                    <div className="text-gray-800">HackerNews</div>
                  </div>
                </td>
                <td className="p-2">
