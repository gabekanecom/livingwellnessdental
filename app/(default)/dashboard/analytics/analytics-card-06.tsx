  ...
  return(
    <div className="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white shadow-sm rounded-xl">
      <header className="className="px-5 py-4 border-b border-gray-100 ">
        <h2 className="className="font-semibold text-gray-800 Pages</h2>">
      </header>
      <div className="grow p-3">
        <div className="flex flex-col h-full">
          ...
          <div className="grow">
            ...
            <ul className="space-y-1 text-sm text-gray-800 mt-3 mb-4">
              ...
              <li className="relative px-2 py-1">
                <div className="absolute inset-0 bg-green-50 rounded-r" aria-hidden="true" style={{ width: '82%' }}></div>
              ...
              {/* Item */}
              <li className="relative px-2 py-1">
                <div className="absolute inset-0 bg-green-50 rounded-r" aria-hidden="true" style={{ width: '70%' }}></div>
                <div className="relative flex justify-between space-x-2">
              ...
              {/* Item */}
              <li className="relative px-2 py-1">
                <div className="absolute inset-0 bg-green-50 rounded-r" aria-hidden="true" style={{ width: '60%' }}></div>
                <div className="relative flex justify-between space-x-2">
              ...
              {/* Item */}
              <li className="relative px-2 py-1">
                <div className="absolute inset-0 bg-green-50 rounded-r" aria-hidden="true" style={{ width: '44%' }}></div>
                <div className="relative flex justify-between space-x-2">
              ...
              {/* Item */}
              <li className="relative px-2 py-1">
                <div className="absolute inset-0 bg-green-50 rounded-r" aria-hidden="true" style={{ width: '40%' }}></div>
                <div className="relative flex justify-between space-x-2">
              ...
              {/* Item */}
              <li className="relative px-2 py-1">
                <div className="absolute inset-0 bg-green-50 rounded-r" aria-hidden="true" style={{ width: '30%' }}></div>
                <div className="relative flex justify-between space-x-2">
              ...
              {/* Item */}
              <li className="relative px-2 py-1">
                <div className="absolute inset-0 bg-green-50 rounded-r" aria-hidden="true" style={{ width: '22%' }}></div>
                <div className="relative flex justify-between space-x-2">
              ...
              {/* Item */}
              <li className="relative px-2 py-1">
                <div className="absolute inset-0 bg-green-50 rounded-r" aria-hidden="true" style={{ width: '12%' }}></div>
                <div className="relative flex justify-between space-x-2">
          ...
          <div className="className="text-center pt-4 pb-1 border-t border-gray-100 ">
            <Link className="text-sm font-medium text-violet-500 hover:text-violet-600 href="#0">Page Report -&gt;</Link>
          </div>
        </div>
      </div>
    </div>
