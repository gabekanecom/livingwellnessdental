        ...
        <div className="sm:flex sm:justify-between sm:items-center mb-4">
          ...
          <div className="mb-4 sm:mb-0 mr-2">
            <ul className="flex flex-wrap items-center -m-1">
              ...
              <li className="m-1">
                <button className="btn-sm bg-white border-gray-200 hover:border-gray-300 text-violet-500">+Add New</button>
              </li>
            </ul>
          </div>
          ...
          <div className="flex flex-nowrap -space-x-px">
            <button className="btn bg-white border-gray-200 text-violet-500 rounded-none first:rounded-l-lg last:rounded-r-lg">Month</button>
            <button className="btn bg-white border-gray-200 hover:bg-gray-50 text-gray-600 rounded-none first:rounded-l-lg last:rounded-r-lg">Week</button>
            <button className="btn bg-white border-gray-200 hover:bg-gray-50 text-gray-600 rounded-none first:rounded-l-lg last:rounded-r-lg">Day</button>
          </div>
        </div>
