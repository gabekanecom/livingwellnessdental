...
export default function JobsSidebar() {
  ...
  return (
    <div className="space-y-8">
      {/* Alert */}
      <div className="relative bg-linear-to-r from-violet-500/[0.12] to-violet-500/[0.04] rounded-lg p-5">
        ...
        <div className="relative">
          <div className="text-sm font-medium text-gray-800 mb-2">Remember to keep track of your job research.</div>
      ...
      {/* White box */}
      <div className="bg-white shadow-sm rounded-xl p-5 min-w-[15rem]">
        <div className="grid md:grid-cols-2 xl:grid-cols-1 gap-6">
          {/* Group 1 */}
          <div>
            <div className="text-sm text-gray-800 font-semibold mb-3">Job Types</div>
            <ul className="space-y-2">
              <li>
                <label className="flex items-center">
                  <input type="checkbox" className="form-checkbox" defaultChecked />
                  <span className="text-sm text-gray-600 font-medium ml-2">Programming</span>
                </label>
              </li>
              <li>
                <label className="flex items-center">
                  <input type="checkbox" className="form-checkbox" />
                  <span className="text-sm text-gray-600 font-medium ml-2">Design</span>
                </label>
              </li>
              <li>
                <label className="flex items-center">
                  <input type="checkbox" className="form-checkbox" />
                  <span className="text-sm text-gray-600 font-medium ml-2">Management / Finance</span>
                </label>
              </li>
              <li>
                <label className="flex items-center">
                  <input type="checkbox" className="form-checkbox" />
                  <span className="text-sm text-gray-600 font-medium ml-2">Customer Support</span>
                </label>
              </li>
              <li>
                <label className="flex items-center">
                  <input type="checkbox" className="form-checkbox" />
                  <span className="text-sm text-gray-600 font-medium ml-2">Sales / Marketing</span>
                </label>
              </li>
            </ul>
          </div>
          {/* Group 2 */}
          <div>
            <div className="text-sm text-gray-800 font-semibold mb-3">Company Culture</div>
            <div className="flex items-center">
              ...
              <div className="text-sm text-gray-400 italic ml-2">{companySetting ? 'On' : 'Off'}</div>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <label className="flex items-center">
                  <input type="checkbox" className="form-checkbox" defaultChecked />
                  <span className="text-sm text-gray-600 font-medium ml-2">$20K - $50K</span>
                </label>
              </li>
              <li>
                <label className="flex items-center">
                  <input type="checkbox" className="form-checkbox" />
                  <span className="text-sm text-gray-600 font-medium ml-2">$50K - $100K</span>
                </label>
              </li>
              <li>
                <label className="flex items-center">
                  <input type="checkbox" className="form-checkbox" />
                  <span className="text-sm text-gray-600 font-medium ml-2">&gt; $100K</span>
                </label>
              </li>
              <li>
                <label className="flex items-center">
          ...
          {/* Group 4 */}
          <div>
            <div className="text-sm text-gray-800 font-semibold mb-3">Immigration</div>
            <div className="flex items-center">
              <div className="form-switch">
                <input
                  type="checkbox"
              ...
              <div className="text-sm text-gray-400 italic ml-2">{immigrationSetting ? 'On' : 'Off'}</div>
            </div>
