    ...
    <div className="px-4 sm:px-6 lg:px-8 py-8 w-full">
      ...
      <div className="max-w-5xl mx-auto flex flex-col lg:flex-row lg:space-x-8 xl:space-x-16">
        ...
        <div>
          ...
          <div className="text-sm text-gray-500 italic mb-2">Posted Jan 6, 2024</div>
          <header className="mb-4">
            {/* Title */}
            <h1 className="text-2xl md:text-3xl text-gray-800 font-bold">Senior Client Engineer (React &amp; React Native)</h1>
          </header>

          {/* Company information (mobile) */}
          <div className="bg-white p-5 shadow-lg rounded-xl mb-6 lg:hidden">
            <div className="text-center mb-6">
              <div className="inline-flex mb-3">
                <Image className="w-16 h-16 rounded-full" src={Image06} width={64} height={64} alt="Company 01" />
              </div>
              <div className="text-lg font-bold text-gray-800 mb-1">Revolut Ltd</div>
          ...
          <div className="mb-6">
            <div className="flex flex-wrap items-center -m-1">
              <div className="m-1">
                <a className="btn-xs text-xs border-gray-200 hover:border-gray-300 text-gray-800 px-2.5 py-1 rounded-full shadow-none" href="#0">
                  Full-time
                </a>
              </div>
              <div className="m-1">
          ...
          {/* The Role */}
          <div>
            <h2 className="text-xl leading-snug text-gray-800 font-bold mb-2">The Role</h2>
          ...
          {/* About You */}
          <div>
            <h2 className="text-xl leading-snug text-gray-800 font-bold mb-2">About You</h2>
            <div className="space-y-6">
              <p>
          ...
          {/* Things You Might Do */}
          <div>
            <h2 className="text-xl leading-snug text-gray-800 font-bold mb-2">Things You Might Do</h2>
            <div className="space-y-6">
              <p>
          ...
          <div className="mt-6">
            ...
            <div className="flex justify-between items-center">
              {/* Apply button */}
              <button className="btn bg-gray-900 text-gray-100 hover:bg-gray-800 whitespace-nowrap">Apply Today -&gt;</button>
              {/* Share */}
          ...
          {/* Related Jobs */}
          <div>
            <h2 className="text-xl leading-snug text-gray-800 font-bold mb-6">Related Jobs</h2>
