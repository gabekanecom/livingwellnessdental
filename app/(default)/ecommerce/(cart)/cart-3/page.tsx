...
export default function Cart3() {
  return (
    <div className="lg:relative lg:flex">
        ...
        <div className="lg:max-w-[640px] lg:mx-auto">
          ...
          <div className="mb-6 lg:mb-0">
            ...
            <header className="mb-6">
              {/* Title */}
              <h1 className="text-2xl md:text-3xl text-gray-800 font-bold mb-2">Thank you for your order</h1>
              <p>You will soon receive a confirmation email with details of your order and a link to download the files.</p>
            </header>
            {/* Billing Information */}
            <div>
              <div className="text-gray-800 font-semibold mb-4">Billing Information</div>
              <form>
      ...
      {/* Sidebar */}
      <div>
        <div className="lg:sticky lg:top-16 bg-linear-to-r from-white/30 lg:overflow-x-hidden lg:overflow-y-auto no-scrollbar lg:shrink-0 border-t lg:border-t-0 lg:border-l border-gray-200 lg:w-[320px] xl:w-[352px] 2xl:w-[calc(352px+80px)] lg:h-[calc(100dvh-64px)]">
          <div className="py-8 px-4 lg:px-8 2xl:px-12">
            <div className="max-w-sm mx-auto lg:max-w-none">
              <h2 className="text-2xl text-gray-800 font-bold mb-6">Order Summary</h2>
              <div className="space-y-6">

                {/* Order Details */}
                <div>
                  <div className="text-gray-800 font-semibold mb-2">Order Details</div>
                  {/* Cart items */}
                  <ul>
                    {/* Cart item */}
                    <li className="flex items-center py-3 border-b border-gray-200">
                      ...
                      <div className="grow">
                        <a href="#0">
                          <h4 className="text-sm font-medium text-gray-800 leading-tight">The Complete Front-End Development Course!</h4>
                        </a>
                      </div>
                    ...
                    <li className="flex items-center py-3 border-b border-gray-200">
                      ...
                      <div className="grow">
                        <a href="#0">
                          <h4 className="text-sm font-medium text-gray-800 leading-tight">Web Development Ultimate Course 2024</h4>
                        </a>
                      </div>
                      <div className="text-sm font-medium text-gray-800 ml-2">$69</div>
                    </li>
                    ...
                    <li className="flex items-center py-3 border-b border-gray-200">
                      ...
                      <div className="grow">
                        <a href="#0">
                          <h4 className="text-sm font-medium text-gray-800 leading-tight">Full-Stack JavaScript Course!</h4>
                        </a>
                      </div>
                      <div className="text-sm font-medium text-gray-800 ml-2">$69</div>
                    </li>
                ...
                <div>
                  ...
                  <div className="text-sm rounded-sm border border-gray-200 p-3">
