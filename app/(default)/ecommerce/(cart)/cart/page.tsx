        ...
        <div>
          <div className="bg-white p-5 shadow-sm rounded-xl lg:w-[18rem] xl:w-[20rem]">
            ...
            <ul className="mb-4">
              ...
              <li className="text-sm w-full flex justify-between py-3 border-b border-gray-200">
                <div>Shipping</div>
                <div className="font-medium text-gray-800">$12</div>
              </li>
              <li className="text-sm w-full flex justify-between py-3 border-b border-gray-200">
                <div>Taxes</div>
                <div className="font-medium text-gray-800">$36</div>
              </li>
              <li className="text-sm w-full flex justify-between py-3 border-b border-gray-200">
            ...
            <div className="mb-4">
              <button className="btn w-full bg-gray-900 text-gray-100 hover:bg-gray-800">Buy Now - $253.00</button>
            </div>
