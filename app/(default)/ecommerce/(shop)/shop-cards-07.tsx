...
export default function ShopCards07() {
  return (
    <>
      {/* Card 1 */}
      <div className="col-span-full md:col-span-6 xl:col-span-4 bg-white shadow-sm rounded-xl overflow-hidden">
        <div className="flex flex-col h-full">
          ...
          <div className="relative">
            ...
            <div className="absolute bottom-0 right-0 mb-4 mr-4">
              <div className="inline-flex items-center text-xs font-medium text-gray-100 bg-gray-900/60 rounded-full text-center px-2 py-0.5">
      ...
      <div className="col-span-full md:order-1 xl:order-none">
        <div className="h-full p-6 bg-gray-900 rounded-lg text-center xl:text-left xl:flex xl:justify-between xl:items-center">
