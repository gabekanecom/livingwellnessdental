  ...
  return (
    <div className="bg-white shadow-sm rounded-xl p-4">
      ...
      <div className="mb-3">
        ...
        <div className="flex items-center mb-2">
          ...
          <div className="grow">
            <a className="inline-flex text-gray-800 hover:text-gray-900" href="#0">
              <h2 className="font-semibold text-gray-800">Dominik Przetocki</h2>
            </a>
        ...
        {/* Content */}
        <div>
          <div className="text-sm">Dedicated form for a category of users that will perform actions? <a className="font-medium text-violet-500 hover:text-violet-600" href="#0">#viewall</a></div>
        </div>
      </div>
      {/* Footer */}
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center">
          ...
          <button className="flex items-center text-gray-400 hover:text-violet-500 ml-3">
            ...
            <div className="text-sm text-gray-500">9</div>
          </button>
          {/* Attach button */}
