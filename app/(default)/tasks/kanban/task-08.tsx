  ...
  return (
    <div className="bg-white shadow-sm rounded-xl p-4">
      ...
      <div className="mb-3">
        ...
        {/* Content */}
        <div>
          <div className="text-sm">Publishing industries for previewing layouts and visual <a className="font-medium text-violet-500 hover:text-violet-600 href="#0">#family</a> 🔥</div>
