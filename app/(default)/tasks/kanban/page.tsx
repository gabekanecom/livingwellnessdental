    ...
    <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-[96rem] mx-auto">
      ...
      <div className="className="mb-4 border-b border-gray-200 ">
        <ul className="text-sm font-medium flex flex-nowrap -mx-4 sm:-mx-6 lg:-mx-8 overflow-x-scroll no-scrollbar">
          ...
          <li className="pb-3 mr-6 last:mr-0 first:pl-4 sm:first:pl-6 lg:first:pl-8 last:pr-4 sm:last:pr-6 lg:last:pr-8">
            <Link className="text-gray-500 hover:text-gray-600 whitespace-nowrap" href="#0">Web Sprint</Link>
          </li>
          <li className="pb-3 mr-6 last:mr-0 first:pl-4 sm:first:pl-6 lg:first:pl-8 last:pr-4 sm:last:pr-6 lg:last:pr-8">
            <Link className="text-gray-500 hover:text-gray-600 whitespace-nowrap" href="#0">Marketing</Link>
          </li>
          <li className="pb-3 mr-6 last:mr-0 first:pl-4 sm:first:pl-6 lg:first:pl-8 last:pr-4 sm:last:pr-6 lg:last:pr-8">
            <Link className="text-gray-500 hover:text-gray-600 whitespace-nowrap" href="#0">Development</Link>
          </li>
        </ul>
      </div>
