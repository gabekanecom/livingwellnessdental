      ...
      <div className="md:sticky md:top-16 md:h-[calc(100dvh-64px)] md:overflow-x-hidden md:overflow-y-auto no-scrollbar">
        <div className="md:py-8">
          ...
          <header className="mb-6">
            <h1 className="text-2xl md:text-3xl text-gray-800 font-bold">Feed</h1>
          </header>
          ...
          <div className="xl:hidden mb-6">
            <form className="relative">
              ...
              <input id="feed-search-mobile" className="form-input w-full pl-9 bg-white type="search" placeholder="Search…" />
          ...
          <div className="flex flex-nowrap overflow-x-scroll no-scrollbar md:block md:overflow-auto px-4 md:space-y-3 -mx-4">
            {/* Group 1 */}
            <div>
              <div className="text-xs font-semibold text-gray-400 uppercase mb-3 md:sr-only">Menu</div>
              <ul className="flex flex-nowrap md:block mr-3 md:mr-0">
                <li className="mr-0.5 md:mr-0 md:mb-0.5">
                  <a className="flex items-center px-2.5 py-2 rounded-lg whitespace-nowrap bg-white href="#0">
                ...
                <li className="mr-0.5 md:mr-0 md:mb-0.5">
                  <a className="flex items-center px-2.5 py-2 rounded-lg whitespace-nowrap" href="#0">
                    <svg className="shrink-0 fill-current text-gray-400 mr-2" width="16" height="16" viewBox="0 0 16 16">
                    ...
                    <span className="className="text-sm font-medium text-gray-600 ">
                  </a>
                </li>
                <li className="mr-0.5 md:mr-0 md:mb-0.5">
                  <a className="flex items-center px-2.5 py-2 rounded-lg whitespace-nowrap" href="#0">
            ...
            {/* Group 2 */}
            <div>
              <div className="text-xs font-semibold text-gray-400 uppercase mb-3">My Groups</div>
              <ul className="flex flex-nowrap md:block mr-3 md:mr-0">
                <li className="mr-0.5 md:mr-0 md:mb-0.5">
                  <a className="flex items-center px-2.5 py-2 rounded-lg whitespace-nowrap" href="#0">
                    <svg className="shrink-0 fill-current text-gray-400 mr-2" width="16" height="16" viewBox="0 0 16 16">
                ...
                <li className="mr-0.5 md:mr-0 md:mb-0.5">
                  <a className="flex items-center px-2.5 py-2 rounded-lg whitespace-nowrap" href="#0">
                    ...
                    <span className="className="text-sm font-medium text-gray-600 Development</span>">
                  </a>
                </li>
              </ul>
            </div>
