        ...
        <div className="md:py-8">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white p-4 rounded-xl">
              <div className="text-xs font-semibold text-gray-400 uppercase mb-4">Top Communities</div>
            ...
            {/* Block 2 */}
            <div className="bg-white p-4 rounded-xl">
              <div className="text-xs font-semibold text-gray-400 uppercase mb-4">Who to follow</div>
              <ul className="space-y-3">
                <li>
                  <div className="flex items-center justify-between">
                    <div className="grow flex items-center">
            ...
            {/* Block 3 */}
            <div className="bg-white p-4 rounded-xl">
              <div className="text-xs font-semibold text-gray-400 uppercase mb-4">Trends for you</div>
              <ul className="space-y-3">
                <li>
