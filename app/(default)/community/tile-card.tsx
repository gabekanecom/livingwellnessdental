...
export default function TileCard({ user }: { user: User}) {
  return (
    <div className="col-span-full sm:col-span-6 xl:col-span-4 bg-white shadow-sm rounded-xl">
      <div className="flex flex-col h-full">
        ...
        <div className="border-t border-gray-100 ">
          <div className="flex divide-x divide-gray-100 ">
            ...
            <Link className="block flex-1 text-center text-sm text-gray-600 hover:text-gray-800 font-medium px-3 py-4 group" href="/settings/account">
              <div className="flex items-center justify-center">
                <svg className="fill-current text-gray-400 group-hover:text-gray-500 shrink-0 mr-2" width="16" height="16" viewBox="0 0 16 16">
