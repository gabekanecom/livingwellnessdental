...
export default function TabCard({ user }: { user: User}) {
  return (
    <div className="col-span-full sm:col-span-6 xl:col-span-3 bg-white shadow-sm rounded-xl">
      <div className="flex flex-col h-full">
        ...
        <div className="grow p-5">
          ...
          <header>
            ...
            <div className="flex justify-center items-center"><span className="text-sm font-medium text-gray-400 -mt-0.5 mr-1">-&gt;</span> <span>{user.location}</span></div>
          </header>
          {/* Bio */}
