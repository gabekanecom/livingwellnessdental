      ...
      <div className="max-w-5xl mx-auto flex flex-col lg:flex-row lg:space-x-8 xl:space-x-16">
        ...
        <div>
          ...
          <header className="mb-4">
            {/* Title */}
            <h1 className="text-2xl md:text-3xl text-gray-800 font-bold mb-2">The World of AI and Machine Learning — Open Chat</h1>
          ...
          <div className="space-y-3 sm:flex sm:items-center sm:justify-between sm:space-y-0 mb-6">
            ...
            <div className="flex flex-wrap items-center sm:justify-end space-x-2">
              {/* Tags */}
              <div className="text-xs inline-flex items-center font-medium border border-gray-200 text-gray-600 rounded-full text-center px-2.5 py-1">
                <svg className="w-4 h-3 fill-gray-400 mr-2" viewBox="0 0 16 12">
          ...
          {/* Post content */}
          <div>
            <h2 className="text-xl leading-snug text-gray-800 font-bold mb-2">Meetup Details</h2>
          ...
          {/* Photos */}
          <div>
            <h2 className="text-xl leading-snug text-gray-800 font-bold mb-2">Photos (3)</h2>
          ...
          {/* Comments */}
          <div>
            <h2 className="text-xl leading-snug text-gray-800 font-bold mb-2">Comments (3)</h2>
            <ul className="space-y-5 my-6">
              ...
              <li className="flex items-start">
                ...
                <div className="grow">
                  <div className="text-sm font-semibold text-gray-800 mb-2">Taylor Nieman</div>
              ...
              <li className="flex items-start">
                ...
                <div className="grow">
                  <div className="text-sm font-semibold text-gray-800 mb-2">Meagan Loyst</div>
                  <div className="italic">
                    “Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                    Ut enim ad minim veniam.”
                  </div>
              ...
              <li className="flex items-start">
                ...
                <div className="grow">
                  <div className="text-sm font-semibold text-gray-800 mb-2">Frank Malik</div>
                  <div className="italic">
                    “Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                    Ut enim ad minim veniam.”
                  </div>
          ...
          {/* Similar Meetups */}
          <div>
            <h2 className="text-xl leading-snug text-gray-800 font-bold mb-2">Similar Meetups</h2>
            <div className="space-y-8 sm:space-y-5 my-6 lg:mb-0">
              {/* Related item */}
              <article className="flex bg-white shadow-sm rounded-xl overflow-hidden">
                {/* Image */}
                ...
                <div className="grow p-5 flex flex-col">
                  ...
                  <div className="flex justify-between items-center mt-3">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <div className="text-xs font-medium text-gray-400 italic">+132</div>
                    </div>
                  </div>
                </div>
              </article>
