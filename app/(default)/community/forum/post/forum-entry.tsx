...
export default function ForumEntry() {
  return (
    <article className="bg-white shadow-sm rounded-xl p-5">
      {/* Breadcrumbs */}
      <div className="mb-2">
        <ul className="inline-flex flex-wrap text-sm font-medium">
          <li className="flex items-center">
            <Link className="text-gray-500 hover:text-violet-500" href="/community/forum">
              Home
            </Link>
            <svg className="fill-current text-gray-400 mx-2" width="16" height="16" viewBox="0 0 16 16">
              <path d="M6.6 13.4L5.2 12l4-4-4-4 1.4-1.4L12 8z" />
            </svg>
          </li>
          <li className="flex items-center">
            <a className="text-gray-500 hover:text-violet-500" href="#0">
              Discussion
            </a>
          </li>
        </ul>
      ...
      <header className="pb-4">
        ...
        <div className="flex items-start space-x-3 mb-3">
          <h2 className="text-2xl text-gray-800 font-bold">Besides Product Hunt, where else should I promote my new project? 🤔</h2>
          {/* Upvote button */}
          <div className="shrink-0">
            <button className="text-xs font-semibold text-center h-12 w-12 border border-gray-200 hover:border-gray-300 rounded-lg flex flex-col justify-center items-center">
              <svg className="inline-flex fill-gray-400 mt-1.5 mb-1.5" width="12" height="6" xmlns="http://www.w3.org/2000/svg">
      ...
      <div>
        ...
        <div className="text-right">
          <button type="submit" className="btn-sm bg-gray-900 text-gray-100 hover:bg-gray-800 whitespace-nowrap">
            Reply -&gt;
          </button>
        </div>
      </div>
      ...
      <div className="mt-4">
        ...
        <ul className="space-y-5">
          ...
          <li className="relative pl-9 space-y-5">
            ...
            <div className="flex items-start">
              ...
              <div className="absolute top-0 left-0">
                <button className="text-xs font-semibold text-left w-6 rounded-xs flex flex-col justify-center items-center text-gray-600 hover:text-violet-500 ">
                  <svg className="inline-flex fill-gray-400 mt-1.5 mb-1.5" width="12" height="6" xmlns="http://www.w3.org/2000/svg">
                    <path d="m0 6 6-6 6 6z" />
                  </svg>
                  <div>44</div>
              ...
              <div>
                {/* Comment text */}
                <div className="grow text-sm text-gray-800 space-y-2 mb-2">
                  <p>
                ...
                <div className="flex flex-wrap text-xs">
                  ...
                  <div className="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-gray-400 after:px-2">
                    <a className="font-medium text-gray-500 hover:text-gray-600" href="#0">
                      Reply
                    </a>
                  </div>
                  <div className="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-gray-400 after:px-2">
          ...
          <li className="relative pl-9 space-y-5">
            ...
            <div className="flex items-start">
              {/* Comment upvote */}
              <div className="absolute top-0 left-0">
                <button className="text-xs font-semibold text-left w-6 rounded-xs flex flex-col justify-center items-center text-gray-600">
        ...
        <div className="text-center mt-5">
          <button className="text-sm font-medium text-violet-500 hover:text-violet-600">More Comments</button>
        </div>
      </div>
    </article>
  )
