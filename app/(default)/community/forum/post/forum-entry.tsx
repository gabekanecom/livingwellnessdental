        ...
        <ul className="space-y-5">
          ...
          <li className="relative pl-9 space-y-5">
            ...
            <div className="flex items-start">
              ...
              <div className="absolute top-0 left-0">
                <button className="className="text-xs font-semibold text-left w-6 rounded-xs flex flex-col justify-center items-center text-gray-600 hover:text-violet-500 ">
                  <svg className="inline-flex fill-gray-400 mt-1.5 mb-1.5" width="12" height="6" xmlns="http://www.w3.org/2000/svg">
                    <path d="m0 6 6-6 6 6z" />
                  </svg>
                  <div>44</div>
          ...
          <li className="relative pl-9 space-y-5">
            ...
            <div className="flex items-start">
              {/* Comment upvote */}
              <div className="absolute top-0 left-0">
                <button className="className="text-xs font-semibold text-left w-6 rounded-xs flex flex-col justify-center items-center text-gray-600 ">
