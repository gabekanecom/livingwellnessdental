        ...
        <div className="md:py-8">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white p-4 rounded-xl">
              <div className="text-xs font-semibold text-gray-400 uppercase mb-4">Forum Meetups</div>
              <ul>
                {/* Event 1 */}
            ...
            {/* Block 2 */}
            <div className="bg-white p-4 rounded-xl">
              <div className="text-xs font-semibold text-gray-400 uppercase mb-4">Popular Stories</div>
