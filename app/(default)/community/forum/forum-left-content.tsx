        ...
        <div className="md:py-8">
          <div className="flex justify-between items-center md:block">
            ...
            <header className="mb-6">
              <h1 className="text-2xl md:text-3xl text-gray-800 font-bold">Forum</h1>
            </header>

            {/* Button */}
            <div className="xl:hidden mb-6">
              <button className="className="btn md:w-full bg-gray-900 text-gray-100 hover:bg-gray-800 Post</button>">
            </div>
          </div>
              ...
              <ul className="flex flex-nowrap md:block mr-3 md:mr-0">
                ...
                <li className="mr-0.5 md:mr-0 md:mb-0.5">
                  <a className="flex items-center px-2.5 py-2 rounded-lg whitespace-nowrap" href="#0">
                    ...
                    <span className="className="text-sm font-medium text-gray-600 List</span>">
                  </a>
                </li>
                <li className="mr-0.5 md:mr-0 md:mb-0.5">
                  <a className="flex items-center px-2.5 py-2 rounded-lg whitespace-nowrap" href="#0">
