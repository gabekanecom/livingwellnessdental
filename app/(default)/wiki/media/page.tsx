...
import { PhotoIcon, MagnifyingGlassIcon, FunnelIcon } from '@heroicons/react/24/outline';
    ...
    <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-[96rem] mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Browse and manage your uploaded images and media files
        </p>
      </div>
        ...
        <div className="bg-white shadow-sm rounded-lg p-12 text-center">
          ...
          <p className="text-gray-600">
            {search || contentType
              ...
              : 'Upload images in the article editor to see them here'}
          </p>
        </div>
      ) : (
        <>
                ...
                <div className="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-60 transition-all duration-200">
                  <div className="absolute bottom-0 left-0 right-0 p-3 text-white transform translate-y-full group-hover:translate-y-0 transition-transform duration-200">
                    ...
                    <div className="mt-1 text-xs opacity-75">
                      ...
                      <p>Used in {item.usageCount} article{item.usageCount !== 1 ? 's' : ''}</p>
                    </div>
                  </div>
                </div>
              </div>
