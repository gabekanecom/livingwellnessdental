  ...
  return (
    <div className="grow">
      ...
      <div className="p-6 space-y-6">
        ...
        <section>
          ...
          <div>
            ...
            <div className="grid grid-cols-12 gap-6">
              {/* Tab 1 */}
              <div className="relative col-span-full xl:col-span-4 bg-white border border-gray-200 shadow-sm rounded-b-lg">
              ...
              <div className="relative col-span-full xl:col-span-4 bg-white border border-gray-200 shadow-sm rounded-b-lg">
                ...
                <div className="px-5 pt-5 pb-6 border-b border-gray-200">
                  ...
                  {/* CTA */}
                  <button className="btn w-full bg-gray-900 text-gray-100 hover:bg-gray-800 disabled:border-gray-200 disabled:bg-white disabled:text-gray-300 disabled:cursor-not-allowed" disabled>
              ...
              <div className="relative col-span-full xl:col-span-4 bg-white border border-gray-200 shadow-sm rounded-b-lg">
                ...
                <div className="px-5 pt-5 pb-6 border-b border-gray-200">
                  ...
                  {/* CTA */}
                  <button className="btn bg-gray-900 text-gray-100 hover:bg-gray-800 w-full">Upgrade</button>
                </div>
                <div className="px-5 pt-4 pb-5">
                  <div className="text-xs text-gray-800 font-semibold uppercase mb-4">What's included</div>
                  {/* List */}
        ...
        {/* Contact Sales */}
        <section>
          <div className="px-5 py-3 bg-linear-to-r from-violet-500/[0.12] to-violet-500/[0.04] rounded-lg text-center xl:text-left xl:flex xl:flex-wrap xl:justify-between xl:items-center">
            <div className="text-gray-800 font-semibold mb-2 xl:mb-0">Looking for different configurations?</div>
            <button className="btn bg-gray-900 text-gray-100 hover:bg-gray-800">Contact Sales</button>
          </div>
        </section>
