      ...
      <div className="p-6 space-y-6">
        ...
        <section>
          <div className="flex items-center">
            ...
            <button className="btn-sm border-gray-200 hover:border-gray-300 text-gray-800">Change</button>
          </div>
        </section>
        {/* Business Profile */}
        <section>
        ...
        <section>
          ...
          <div className="flex flex-wrap mt-5">
            ...
            <button className="btn border-gray-200 hover:border-gray-300 text-gray-800">Update Email</button>
          </div>
        </section>
        {/* Password */}
        <section>
          ...
          <div className="mt-5">
            <button className="btn border-gray-200 hover:border-gray-300 text-gray-800">Set New Password</button>
          </div>
        </section>
        {/* Smart Sync */}
        <section>
