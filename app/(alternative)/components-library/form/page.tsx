  ...
  return (
    <div className="relative bg-white h-full">
      <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-[96rem] mx-auto">
        {/* Page header */}
        <div className="mb-8">
          <h1 className="text-2xl md:text-3xl text-gray-800 font-bold">Input Form</h1>
        </div>
                ...
                <div>
                  ...
                  <form>
                    ...
                    <div className="relative">
                      ...
                      <div className="absolute inset-0 right-auto flex items-center pointer-events-none">
                        <svg className="fill-current text-gray-400 shrink-0 ml-3 mr-2" width="16" height="16" viewBox="0 0 16 16">
              ...
              <div className="grid gap-5 md:grid-cols-3">
                <div>
                  ...
                  <div>
                    ...
                    <input
                      id="disabled"
                      className="form-input w-full disabled:border-gray-200 disabled:bg-gray-100 disabled:text-gray-400 disabled:cursor-not-allowed shadow-none"
                      type="text"
