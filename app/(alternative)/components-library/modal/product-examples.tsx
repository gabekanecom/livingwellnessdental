      ...
      <div className="flex flex-wrap items-center -m-1.5">
          ...
          <ModalAction isOpen={newsletterModalOpen} setIsOpen={setNewsletterModalOpen}>
            ...
            <div className="text-center">
              ...
              <form className="flex max-w-sm m-auto">
                ...
                <button type="submit" className="btn-sm bg-gray-900 text-gray-100 hover:bg-gray-800 whitespace-nowrap">Subscribe</button>
              </form>
        ...
        <div className="m-1.5">
          ...
          <ModalAction isOpen={announcementModalOpen} setIsOpen={setAnnouncementModalOpen}>
            ...
            <div className="mb-2 text-center">
              {/* Icon */}
              <div className="inline-flex rounded-full bg-linear-to-b from-gray-100 to-gray-200 mb-2">
        ...
        <div className="m-1.5">
          ...
          <ModalBlank isOpen={newsModalOpen} setIsOpen={setNewsModalOpen}>
            ...
            <div className="p-5">
              ...
              <div className="mb-2">
                <div className="mb-3">
                  <div className="btn-xs text-xs border-gray-200 hover:border-gray-300 text-gray-800 px-2.5 py-1 rounded-full shadow-none">New on Mosaic</div>
                </div>
                  ...
                  <li>
                    <button className="w-full h-full text-left py-3 px-4 rounded-lg bg-white> border border-gray-200 hover:border-gray-300 shadow-sm transition">
                      <div className="flex items-center">
                        ...
                        <div className="grow">
                          <div className="flex flex-wrap items-center justify-between mb-0.5">
                            <span className="font-semibold text-gray-800">Mosaic Basic <span className="text-xs italic text-violet-500 align-top">Best Value</span></span>
