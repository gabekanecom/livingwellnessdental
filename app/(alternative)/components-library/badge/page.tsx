          ...
          <div className="space-y-8 mt-8">
            ...
            <div>
              ...
              <div className="flex flex-wrap items-center -m-1.5">
                ...
                <div className="m-1.5">
                  {/* Start */}
                  <div className="text-xs inline-flex font-medium bg-gray-400/20 text-gray-500 rounded-full text-center px-2.5 py-1">All Stories</div>
                  {/* End */}
                </div>
                <div className="m-1.5">
                  {/* Start */}
            ...
            <div>
              ...
              <div className="flex flex-wrap items-center -m-1.5">
                ...
                <div className="m-1.5">
                  {/* Start */}
                  <div className="text-sm inline-flex font-medium bg-gray-400/20 text-gray-500 rounded-full text-center px-2.5 py-1">All Stories</div>
                  {/* End */}
                </div>
                <div className="m-1.5">
                  {/* Start */}
