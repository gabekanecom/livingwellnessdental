      ...
      <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-[96rem] mx-auto">
        ...
        <div>
          ...
          <div className="space-y-8 mt-8 mb-80">
            ...
            <div>
              <h2 className="text-2xl text-gray-800 font-bold mb-6">Datepicker (built with <a className="underline hover:no-underline" href="https://daypicker.dev" target="_blank" rel="noreferrer">React Day Picker</a>)</h2>
              <Datepicker />
            </div>
