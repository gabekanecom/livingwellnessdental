...
export default function CreditCards() {
  return (
    <div className="lg:relative lg:flex bg-white">
      ...
      <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-[96rem] mx-auto">
        ...
        <div className="sm:flex sm:justify-between sm:items-center mb-5">
          ...
          <div className="mb-4 sm:mb-0">
            <h1 className="text-2xl md:text-3xl text-gray-800 font-bold">Cards</h1>
          </div>
        ...
        <div className="mb-5">
          <ul className="flex flex-wrap -m-1">
            <li className="m-1">
              <button className="inline-flex items-center justify-center text-sm font-medium leading-5 rounded-full px-3 py-1 border border-transparent shadow-sm bg-gray-900 text-white transition">
                View All
              </button>
            </li>
            <li className="m-1">
              <button className="inline-flex items-center justify-center text-sm font-medium leading-5 rounded-full px-3 py-1 border border-gray-200 hover:border-gray-300 shadow-sm bg-white text-gray-500 transition">
                Physical Cards
              </button>
            </li>
            <li className="m-1">
        ...
        <div className="space-y-2">
          ...
          <label className="relative block cursor-pointer text-left w-full">
            ...
            <div className="p-4 rounded-lg border border-gray-200 hover:border-gray-300 shadow-sm transition">
              <div className="grid grid-cols-12 items-center gap-x-2">
                ...
                <div className="col-span-6 order-1 sm:order-none sm:col-span-3 flex items-center space-x-4 lg:sidebar-expanded:col-span-6 xl:sidebar-expanded:col-span-3">
                  ...
                  <div>
                    <div className="text-sm font-medium text-gray-800">_Metal</div>
                ...
                <div className="col-span-6 order-2 sm:order-none sm:col-span-3 text-left sm:text-center lg:sidebar-expanded:hidden xl:sidebar-expanded:block">
                  <div className="text-sm font-medium text-gray-800 truncate">Dominik Lamakani</div>
                </div>
                {/* Card limits */}
            ...
            <div
              className="absolute inset-0 border-2 border-transparent peer-checked:border-violet-400 rounded-lg pointer-events-none"
              aria-hidden="true"
            />
          </label>
            ...
            <div className="p-4 rounded-lg border border-gray-200 hover:border-gray-300 shadow-sm transition">
              <div className="grid grid-cols-12 items-center gap-x-2">
                ...
                <div className="col-span-6 order-1 sm:order-none sm:col-span-3 flex items-center space-x-4 lg:sidebar-expanded:col-span-6 xl:sidebar-expanded:col-span-3">
                  ...
                  <div>
                    <div className="text-sm font-medium text-gray-800">_Virtual</div>
      ...
      {/* Sidebar */}
      <div>
        <div className="lg:sticky lg:top-16 bg-linear-to-b from-gray-100 to-white lg:overflow-x-hidden lg:overflow-y-auto no-scrollbar lg:shrink-0 border-t lg:border-t-0 lg:border-l border-gray-200 lg:w-[390px] lg:h-[calc(100dvh-64px)]">
          <div className="py-8 px-4 lg:px-8">
            <div className="max-w-sm mx-auto lg:max-w-none">

              <div className="text-gray-800 font-semibold text-center mb-6">Physical Metal Card Summary</div>
              ...
              <div className="flex items-center space-x-3 mt-6">
                ...
                <div className="w-1/2">
                  <button className="btn w-full border-gray-200 hover:border-gray-300 text-red-500">
