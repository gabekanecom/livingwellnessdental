...
export default function TransactionPanel() {
  ...
  return (
    ...
    >
      <div className="sticky top-16 bg-linear-to-b from-gray-100 to-white overflow-x-hidden overflow-y-auto no-scrollbar shrink-0 border-l border-gray-200 w-full sm:w-[390px] h-[calc(100dvh-64px)]">
        ...
        {transaction &&
          <div className="py-8 px-4 lg:px-8">
            <div className="max-w-sm mx-auto lg:max-w-none">
              <div className="text-gray-800 font-semibold text-center mb-1">Bank Transfer</div>
              ...
              <div className="drop-shadow-md mt-12">
                ...
                <div className="bg-white rounded-t-xl px-5 pb-2.5 text-center">
                  ...
                  <div className="text-sm font-medium text-gray-800 mb-3">{transaction.name}</div>
                ...
                <div className="bg-white rounded-b-xl p-5 pt-2.5 text-sm space-y-3">
                  <div className="flex justify-between space-x-1">
                    ...
                    <span className="font-medium text-gray-700 text-right">IT17 2207 1010 0504 0006 88</span>
                  </div>
                  <div className="flex justify-between space-x-1">
                    <span className="italic">BIC:</span>
                    <span className="font-medium text-gray-700 text-right">BARIT22</span>
                  </div>
                  <div className="flex justify-between space-x-1">
                    <span className="italic">Reference:</span>
                    <span className="font-medium text-gray-700 text-right">Freelance Work</span>
                  </div>
                  <div className="flex justify-between space-x-1">
                    <span className="italic">Emitter:</span>
                    <span className="font-medium text-gray-700 text-right">Acme LTD UK</span>
                  </div>
                </div>
              </div>
              {/* Receipts */}
              <div className="mt-6">
                <div className="text-sm font-semibold text-gray-800 mb-2">Receipts</div>
                <form className="rounded-sm bg-gray-100 border border-dashed border-gray-300 text-center px-5 py-8">
                  <svg className="inline-flex fill-gray-400 mb-3" width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                    <path d="M8 4c-.3 0-.5.1-.7.3L1.6 10 3 11.4l4-4V16h2V7.4l4 4 1.4-1.4-5.7-5.7C8.5 4.1 8.3 4 8 4ZM1 2h14V0H1v2Z" />
                  </svg>
                  <label htmlFor="upload" className="block text-sm text-gray-500 italic">
