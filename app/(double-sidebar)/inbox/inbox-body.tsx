  ...
  return (
    ...
    >
      ...
      <div className="sticky top-16">
        <div className="flex items-center justify-between before:absolute before:inset-0 before:backdrop-blur-md before:bg-gray-50/90 before:-z-10 border-b border-gray-200 px-4 sm:px-6 md:px-5 h-16">
          ...
          <div className="flex items-center">
            <div className="text-xs mr-1">
              <span className="font-medium">1-10</span> <span className="text-gray-500">of</span> <span className="font-medium">467</span>
            </div>
            <button className="p-1.5 shrink-0 rounded-lg bg-white border border-gray-200 hover:border-gray-300 shadow-sm ml-2">
              <svg className="fill-current text-gray-400" width="16" height="16" viewBox="0 0 16 16">
      ...
      <div className="grow px-4 sm:px-6 md:px-5 py-4">
        ...
        {/* Messages box */}
        <div className="bg-white shadow-sm rounded-xl px-6 divide-y divide-gray-200 ">
          {mails.map(mail => (
            <MailItem
              key={mail.id}
              mail={mail} />
        ...
        <div className="flex items-center justify-between bg-white border-t border-gray-200 px-4 sm:px-6 md:px-5 h-16">
          ...
          <form className="grow flex">
            <div className="grow mr-3">
              ...
              <input
                id="message-input"
                className="form-input w-full bg-gray-100 border-transparent focus:bg-white placeholder-gray-500"
                type="text"
                placeholder="Aa"
              />
            </div>
            <button type="submit" className="btn bg-gray-900 text-gray-100 hover:bg-gray-800 whitespace-nowrap">
              Send -&gt;
            </button>
          </form>
        </div>
