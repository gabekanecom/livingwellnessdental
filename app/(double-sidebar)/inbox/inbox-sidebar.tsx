...
export default function InboxSidebar() {
  ...
  return (
    ...
    >
      <div className="sticky top-16 bg-white overflow-x-hidden overflow-y-auto no-scrollbar shrink-0 border-r border-gray-200 md:w-[18rem] xl:w-[20rem] h-[calc(100dvh-64px)]">
        {/* #Marketing group */}
        <div>
          {/* Group header */}
          ...
          <div className="px-5 py-4">
            ...
            <div className="mt-4">
              ...
              <ul className="mb-6">
                <li className="-mx-2">
                  <button className="flex w-full p-2 rounded-lg bg-linear-to-r from-violet-500/[0.12] to-violet-500/[0.04] text-left" onClick={() => setFlyoutOpen(false)}>
