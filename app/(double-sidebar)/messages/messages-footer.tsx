      ...
      <div className="flex items-center justify-between bg-white border-t border-gray-200 px-4 sm:px-6 md:px-5 h-16">
        ...
        <form className="grow flex">
          <div className="grow mr-3">
            ...
            <input id="message-input" className="form-input w-full bg-gray-100 border-transparent focus:bg-white placeholder-gray-500" type="text" placeholder="Aa" />
          </div>
          <button type="submit" className="btn bg-gray-900 text-gray-100 hover:bg-gray-800 whitespace-nowrap">Send -&gt;</button>
        </form>
      </div>
    </div>
  )
