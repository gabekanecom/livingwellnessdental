...
export default function ProfileBody() {
  ...
  return (
    <div
      className={`grow bg-white flex flex-col md:translate-x-0 transition-transform duration-300 ease-in-out ${
        flyoutOpen ? 'translate-x-1/3' : 'translate-x-0'
      }`}
    >
      {/* Profile background */}
      <div className="className="relative h-56 bg-gray-200 ">
      ...
      <div className="relative px-4 sm:px-6 pb-8">
        ...
        <div className="-mt-16 mb-6 sm:mb-3">
          <div className="flex flex-col items-center sm:flex-row sm:justify-between sm:items-end">
            ...
            <div className="flex space-x-2 sm:mb-2">
              <button className="p-1.5 shrink-0 rounded-lg bg-white border border-gray-200 hover:border-gray-300 shadow-sm">
        ...
        <header className="text-center sm:text-left mb-6">
          ...
          <div className="flex flex-wrap justify-center sm:justify-start space-x-4">
            <div className="flex items-center">
              <svg className="fill-current shrink-0 text-gray-400 width="16" height="16" viewBox="0 0 16 16">
            ...
            <div className="flex items-center">
              ...
              <a className="text-sm font-medium whitespace-nowrap text-violet-500 hover:text-violet-600 ml-2" href="#0">
                carolinmcneail.com
              </a>
            </div>
          </div>
        ...
        <div className="relative mb-6">
          ...
          <ul className="relative text-sm font-medium flex flex-nowrap -mx-4 sm:-mx-6 lg:-mx-8 overflow-x-scroll no-scrollbar">
            ...
            <li className="mr-6 last:mr-0 first:pl-4 sm:first:pl-6 lg:first:pl-8 last:pr-4 sm:last:pr-6 lg:last:pr-8">
              <a className="block pb-3 text-gray-500 hover:text-gray-600 whitespace-nowrap" href="#0">
                Connections
              </a>
            </li>
            <li className="mr-6 last:mr-0 first:pl-4 sm:first:pl-6 lg:first:pl-8 last:pr-4 sm:last:pr-6 lg:last:pr-8">
        ...
        <div className="flex flex-col xl:flex-row xl:space-x-16">
              ...
              <div className="grid xl:grid-cols-2 gap-4">
                ...
                <div className="bg-white p-4 border border-gray-200 rounded-lg shadow-sm">
                  ...
                  <div className="grow flex items-center truncate mb-2">
                    ...
                    <div className="truncate">
                      <span className="className="text-sm font-medium text-gray-800 Marketing</span>">
                    </div>
                  </div>
                  {/* Card content */}
                ...
                <div className="bg-white p-4 border border-gray-200 rounded-lg shadow-sm">
                  ...
                  <div className="grow flex items-center truncate mb-2">
                    ...
                    <div className="truncate">
                      <span className="className="text-sm font-medium text-gray-800 Product</span>">
                    </div>
                  </div>
                  {/* Card content */}
                  <div className="text-sm mb-3">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore.</div>
                ...
                <ul className="space-y-3">
                  ...
                  <li className="sm:flex sm:items-center sm:justify-between">
                    <div className="sm:grow flex items-center text-sm">
                      ...
                      {/* Position */}
                      <div>
                        <div className="className="font-medium text-gray-800 Product Designer</div>">
                    ...
                    <div className="sm:ml-2 mt-2 sm:mt-0">
                      <ul className="flex flex-wrap sm:justify-end -m-1">
                        <li className="m-1">
                          <button className="inline-flex items-center justify-center text-xs font-medium leading-5 rounded-full px-2.5 py-0.5 border border-gray-200 hover:border-gray-300 shadow-sm bg-white text-gray-500 transition">
                            Marketing
                          </button>
                        </li>
                        <li className="m-1">
                  ...
                  <li className="sm:flex sm:items-center sm:justify-between">
                    <div className="sm:grow flex items-center text-sm">
                      ...
                      {/* Position */}
                      <div>
                        <div className="className="font-medium text-gray-800 Designer</div>">
                        <div className="flex flex-nowrap items-center space-x-2 whitespace-nowrap">
                          <div>Milan, IT</div>
                          <div className="className="text-gray-400 ">
          ...
          <aside className="xl:min-w-[14rem] xl:w-[14rem] space-y-3">
            <div className="text-sm">
              <h3 className="className="font-medium text-gray-800 ">
            ...
            <div className="text-sm">
              <h3 className="className="font-medium text-gray-800 Acme</h3>">
