                ...
                <form>
                  <div className="space-y-3 mb-8">
                    <label className="relative block cursor-pointer">
                      ...
                      <div className="flex items-center bg-white text-sm font-medium text-gray-800 p-4 rounded-lg border border-gray-200 hover:border-gray-300 shadow-sm transition">
                  ...
                  <div className="flex items-center justify-between">
                    <Link className="btn bg-gray-900 text-gray-100 hover:bg-gray-800 ml-auto" href="/onboarding-02">Next Step -&gt;</Link>
                  </div>
                </form>
