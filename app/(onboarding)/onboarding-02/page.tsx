                ...
                <form>
                  <div className="sm:flex space-y-3 sm:space-y-0 sm:space-x-4 mb-8">
                    <label className="flex-1 relative block cursor-pointer">
                      ...
                      <div className="h-full text-center bg-white px-4 py-6 rounded-lg border border-gray-200 hover:border-gray-300 shadow-sm transition">
                        <svg
                        ...
                        <div className="font-semibold text-gray-800 mb-1">Individual</div>
                        <div className="text-sm">Lorem ipsum is place text commonly used.</div>
                      </div>
                      <div className="absolute inset-0 border-2 border-transparent peer-checked:border-violet-400 rounded-lg pointer-events-none" aria-hidden="true"></div>
                    </label>
                    <label className="flex-1 relative block cursor-pointer">
                      ...
                      <div className="h-full text-center bg-white px-4 py-6 rounded-lg border border-gray-200 hover:border-gray-300 shadow-sm transition">
                        ...
                        <div className="font-semibold text-gray-800 mb-1">Organization</div>
                        <div className="text-sm">Lorem ipsum is place text commonly used.</div>
                      </div>
                      <div className="absolute inset-0 border-2 border-transparent peer-checked:border-violet-400 rounded-lg pointer-events-none" aria-hidden="true"></div>
                    </label>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Link className="btn bg-gray-900 text-gray-100 hover:bg-gray-800 ml-auto" href="/onboarding-03">Next Step -&gt;</Link>
                  </div>
                </form>
